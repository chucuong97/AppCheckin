...
public class LichSuSoatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lich_su_soat);
        toolbar = findViewById(R.id.toolbarmanhinhlichsusoat);
    ...
    public void showAlertDialog() {
        ...
        builder.setNegativeButton("Đăng xuất", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent intent2 = new Intent(LichSuSoatActivity.this, MainActivity.class);
    ...
    private void CatchOnItemListView() {
        listViewmanhinhthietlap.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0:
                        Intent intent = new Intent(LichSuSoatActivity.this, ThietLapActivity.class);
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        Intent intent3 = new Intent(LichSuSoatActivity.this, KiemTraPhienBanActivity.class);
